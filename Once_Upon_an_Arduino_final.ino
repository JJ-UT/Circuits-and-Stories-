...
void loop() {
  ...
  if (isOn == true) {
    ...
    for (pos = 0; pos <= 40; pos = pos + 1.5) {
      servoE1.write(pos);


    }

    for (pos = 40; pos >= 0; pos = pos - 1.5) {
      servoE1.write(pos);
 ...
 //if (event2 == true) {
  ...
  // same button as event 2
      ...
      //event4 = true;
        ...
        servoE3.write(90);
    //     for (pos2 = 0; pos2 <= 120; pos2 = pos2 + 1) {
    //   servoE3.write(pos2);

    //     }

    //    for (pos2 =120; pos2 >= 0; pos2 = pos2 - 1) {
    //   servoE3.write(pos2);
...
// if button is on, rotate servo by 40 degrees
    ...
    //    for (pos2 = 36.5; pos2 >= 0; pos2 = pos2 - 1.5) {
    //   servoE4.write(pos2);
